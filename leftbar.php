  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="assets/img/icon/user.png"  alt="" data-src="assets/img/icon/user.png" data-src-retina="assets/img/icon/user.png" width="69" height="69" /> </div>
        <div class="user-info">
