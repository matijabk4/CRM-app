...
<td><img src="img/user.png" width="120" height="100"  style="border:solid 1px #000000;" title="No Image available" /></td>
<?php } else { ?>
    <td><img src="img/user.png<?php echo $rw['user_image'];?>" width="120" height="80"  style="border:solid 1px #000000;" /></td>
  <?php } ?>
  </tr>
